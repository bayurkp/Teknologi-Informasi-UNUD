...
void ulangProgram()
{
    ...
    printf("||                " BOLD "CV. SAUBERES WASSER" BOLD_END "                 ||\n");
    printf("|| ================================================== ||\n");
    printf("||     Saya Sara, mengucapkan terima kasih atas       ||\n");
    printf("||  kerjasama Anda dan semoga program ini membantu.   ||\n");
    printf("|| ================================================== ||\n");
...
void rekapitulasi(char nama[], char kelompok[], char golongan[], float selisihPemakaian, float biayaPemakaian, float bpm , float adm) {
    ...
    float biayaPerM3;
    if (selisihPemakaian > 0 && selisihPemakaian <= 10) biayaPerM3 = biayaPemakaian / 10;
    else biayaPerM3 = biayaPemakaian / selisihPemakaian;
    ...
    printf("|| ================================================== ||\n");
    printf("|| Pemakaian bln ini : %.2f m3\n", selisihPemakaian);
    printf("|| Biaya per m3      : %.2f m3\n", biayaPerM3);
    printf("|| ================================================== ||\n");
    ...
    printf("|| ================================================== ||\n");
    printf("|| Total             : Rp %.2f\n", (biayaPemakaian + bpm + denda + adm));
    printf("|| ================================================== ||\n");


    printf("\n\n|| ================================================== ||\n");
    printf("||               " BOLD "PERINGATAN DARI SARA!!" BOLD_END "               ||\n");
    printf("|| ================================================== ||\n");
    if (sisaWaktu <= 0) printf("|| Halo %s, jatuh tempo pada %d hari lagi.\n", nama, -1 * sisaWaktu);
    else printf("|| Halo %s, jatuh tempo telah lewat %d hari.\n", nama, sisaWaktu);
    printf("|| ================================================== ||\n");
    getchar();
...
void intro()
{
    ...
    printf("|| ================================================== ||\n");
    printf("||   Halo, perkenalkan saya Sara yang akan menjadi    ||\n");
    printf("||   pemandu Anda untuk mengoperasikan program ini.   ||\n");
    printf("|| ================================================== ||\n");
    printf("||                      Oleh :                        ||\n");
    printf("||                                                    ||\n");
    printf("||      Putu Andri Krisnantari      2205551054        ||\n");
    printf("||      Bayu Rizky Kurnia Pratama   2205551070        ||\n");
    printf("|| ================================================== ||\n");
